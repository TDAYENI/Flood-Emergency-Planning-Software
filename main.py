...
# else:
#     y_cord = int(input("please enter a numeric Nothings coordinate value between 80000 - 95000: "))
#     while y_cord < 80000 or y_cord > 95000:
#         y_cord = int(input(
#             "Entry not in range. Please enter a numeric Nothings coordinate value between 80000 - 95000: "))
#     else:
#         print("Your location ", x_cord, " Easting and ", y_cord, " Nothings is within the Nothings and easting "
#                                                                  "bounds ")
...
# point = Point(435467.0003706848, 89877.89764861623) # boundary point test
# point = Point(458703.8009043259, 79878.203815303283) #boundary point test
# point = Point(442533.5998012663, 92429.09739499213) # boundary point along river
...
# return a linestring geometry of the boundary/polygon of the isle of wight
...
# Code sourced from aldolipani ,(2020),8 - Week/8 - RTree and NetworkX with Solutions.ipynb, Github
# https://github.com/aldolipani/CEGE0096/blob/master/8%20-%20Week/8%20-%20RTree%20and%20NetworkX%20with%20Solutions.ipynb
# Instantiate graph
...
# identify rows and columns of the pixels (in the elevation array)
...
elev_img = ax.imshow(elevation_matrix_cut, origin='upper', alpha=0.5,
...
plt.title('Isle of Wight Emergency Route Planner', fontsize=7)

# Create North arrow and legends
